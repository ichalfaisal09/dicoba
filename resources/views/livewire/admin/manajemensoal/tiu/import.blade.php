<div class="flex h-full w-full flex-1 flex-col gap-6">
    ...
    <flux:card>
        <div class="flex flex-col gap-2">
            <flux:heading size="lg">{{ __('Import Soal TIU') }}</flux:heading>
            <flux:text variant="muted">
                {{ __('Pilih variasi TIU terlebih dahulu, kemudian unggah berkas JSON yang berisi daftar soal dan opsi jawaban.') }}
            </flux:text>
        </div>
        ...
        <div class="mt-6 space-y-6">
            <flux:field>
                ...
                <flux:select id="variasi" wire:model="variasiId" placeholder="{{ __('Pilih variasi TIU') }}">
            ...
            <flux:field>
                ...
                <flux:text variant="muted">
                    {{ __('Format JSON harus berupa array berisi objek soal dengan atribut teks_soal, tingkat_kesulitan, opsi (A–E) beserta skor 0–5, serta opsional pembahasan dan referensi.') }}
                </flux:text>
        ...
        <div class="mt-6 flex flex-wrap items-center gap-3">
            ...
            <flux:button icon="arrow-uturn-left" variant="ghost" :href="route('admin.manajemen-soal.tiu')"
                wire:navigate>
    ...
    <flux:card variant="soft" color="neutral">
        ...
        <flux:text variant="muted" class="mt-2">
            {{ __('Setiap isi array mewakili satu soal TIU. Huruf opsi akan otomatis diisi A–E apabila tidak disediakan.') }}
        </flux:text>
...
<code>{!! json_encode(
    [
        [
            'teks_soal' => 'Berapakah hasil dari 128 + 245?',
            'tingkat_kesulitan' => 'sedang',
            'opsi' => [
                ['huruf' => 'A', 'teks' => '362', 'skor' => 0],
                ['huruf' => 'B', 'teks' => '373', 'skor' => 5],
                ['huruf' => 'C', 'teks' => '374', 'skor' => 0],
                ['huruf' => 'D', 'teks' => '375', 'skor' => 0],
                ['huruf' => 'E', 'teks' => '384', 'skor' => 0],
            ],
            'pembahasan' => '128 + 245 = 373.',
            'referensi' => 'Modul TIU BKN 2025, Bab 1',
        ],
    ],
