...
#[Layout('layouts.app')]
class CreateTiu extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.manajemensoal.tiu.create', [
            'variasiList' => $groupedVariasi,
        ])->layoutData([
            'title' => __('Tambah Soal TIU'),
        ]);
    }
    ...
    public function store(): void
    {
        ...
        session()->flash('callout', [
            ...
            'text' => __('Soal TIU baru telah ditambahkan ke bank soal.'),
        ]);
