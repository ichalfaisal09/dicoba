...
#[Layout('layouts.app')]
class CreateTkp extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.manajemensoal.tkp.create', [
            'variasiList' => $groupedVariasi,
        ])->layoutData([
            'title' => __('Tambah Soal TKP'),
        ]);
    }
    ...
    public function store(): void
    {
        ...
        session()->flash('callout', [
            ...
            'text' => __('Soal TKP baru telah ditambahkan ke bank soal.'),
        ]);
